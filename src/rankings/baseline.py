...
class HomeFieldBaseline:
    ...
    def predict_game(self, home_team: str, away_team: str, is_neutral: bool = False) -> Tuple[str, float]:
        """
...
class SimpleElo:
    ...
    def update_game(self, home_team: str, away_team: str, home_score: int, 
                   away_score: int, is_neutral: bool = False):
...
class SimpleSRS:
    ...
    def calculate_ratings(self, games_df: pd.DataFrame) -> Dict[str, float]:
        ...
        try:
            ...
            self.ratings = {
                team: point_diffs[team] / max(opponent_counts[team], 1)
                for team in teams
            }
...
def calculate_baseline_rankings(
